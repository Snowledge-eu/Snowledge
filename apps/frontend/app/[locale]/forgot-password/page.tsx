...
export default function ForgotPassword() {
    ...
    const submitInputs = async () => {
        ...
        if (validationError) {
            ...
            try {
              const body = (token) ? { password: formData.password, token: token } : { email: formData.email };
          ...
          </div>
          {
            ...
            ? (<>
                ...
                <div className="flex flex-col space-y-6">
                    <Button className="w-full" onClick={submitInputs}>Change password</Button>
            ...
            : (<>                
                ...
                {/* Sign-in button and sign-up link section */}
                <div className="flex flex-col space-y-6">
                    <Button className="w-full" onClick={submitInputs}>Recovery</Button>
                    <p className="text-sm text-center text-muted-foreground">
                        Don't have an account?{" "}
