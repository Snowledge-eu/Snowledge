...
// RETURNS: JSX.Element
// ============
export function SentimentListCard({
  history,
  onSelect,
}: {
  history: any[];
      ...
      <Table className="w-full text-xs">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="px-2 text-center w-[70px]">
              Sentiment
            </TableHead>
...
export const FAKE_SENTIMENT_HISTORY = [
  {
    ...
    score: 87,
    summary:
      "Majority of messages were positive, with excitement about new features.",
  },
  {
    id: "SEN-002",
    ...
    score: 65,
    summary:
      "Mixed feedback on the latest video, some requests for clarification.",
  },
  {
    id: "SEN-003",
    ...
    score: 42,
    summary:
      "Concerns about moderation and spam, negative sentiment increased.",
  },
];
