...
import { Logo, Button, Checkbox, Input, Label, Card, Switch, Separator, Select, SelectTrigger, SelectValue, SelectContent, SelectItem, PopoverTrigger, Popover, PopoverContent, Spinner, Calendar } from "@repo/ui";
...
export default function CardPlatform({
    ...
    setSelected: (r: {[key: string]: Array<{label:string, value: string}> }) => void;
