...
export class ResourceService {
	...
	// 				summary:
	// 					'Key ML algorithms and their practical applications.',
	// 				description:
	...
	// 				summary:
	// 					'Hands-on projects to apply AI knowledge on real datasets.',
	// 				description:
	...
	// 		description:
	// 			'An intensive workshop to master data science fundamentals.',
	...
	// 				title: 'Data Cleaning',
	// 				summary:
	// 					'Best practices for preparing data before analysis.',
	// 				description:
	...
	// 				summary:
	// 					'Techniques to explore, summarize, and visualize data.',
	// 				description:
